...
class TypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $information = [
            'In many residential buildings, rooms come in standard sizes. Most of these buildings have the same basic rooms, a living room, kitchen, Master bedroom, other bedrooms, bathrooms, guest rooms, laundry rooms, storage rooms, and garage.
While still in the process of planning to build a house, you must determine the standard room sizes for all the rooms in the house. Some standard room dimensions in feet and meters are as',
