        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="mb-2 bg-white rounded cursor-pointer">
                <a href="<?php echo e(route('dashboard.index')); ?>"
                    ...
                    <?php echo e(in_array(\Illuminate\Routing\Route::currentRouteName(), ['dashboard.index', 'chart.dialyGuest']) ? 'active' : ''); ?>
            ...
            <?php if(auth()->user()->role == 'Super' || auth()->user()->role == 'Admin'): ?>
                ...
                <li class="mb-2 bg-white rounded cursor-pointer">
                    <a class="nav-link py-3 border-bottom border-right myBtn  dropdown-toggle
                        <?php echo e(in_array(\Illuminate\Routing\Route::currentRouteName(), ['customer.index', 'customer.create', 'customer.edit', 'user.index', 'user.create', 'user.edit']) ? 'active' : ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel-Hotel-main\Laravel-Hotel-main\resources\views/template/include/_sidebar.blade.php ENDPATH**/ ?>
