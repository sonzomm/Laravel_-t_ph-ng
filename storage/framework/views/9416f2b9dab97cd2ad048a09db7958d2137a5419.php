        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <ul class="progress-indicator m-4">
                    <li
                        class="<?php echo e(Route::currentRouteName() == 'transaction.reservation.createIdentity' ? 'completed' : ''); ?>

                         <?php echo e(Route::currentRouteName() == 'transaction.reservation.pickFromCustomer' ? 'completed' : ''); ?>

                         <?php echo e(Route::currentRouteName() == 'transaction.reservation.viewCountPerson' ? 'completed' : ''); ?>

                         <?php echo e(Route::currentRouteName() == 'transaction.reservation.chooseRoom' ? 'completed' : ''); ?>

                         <?php echo e(Route::currentRouteName() == 'transaction.reservation.confirmation' ? 'completed' : ''); ?>

                         <?php echo e(Route::currentRouteName() == 'transaction.reservation.payDownPayment' ? 'completed' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\new\resources\views/transaction/reservation/progressbar.blade.php ENDPATH**/ ?>