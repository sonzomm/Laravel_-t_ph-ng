        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border">
                ...
                <div class="card-body p-3">
                    <form class="row g-3" method="POST" action="<?php echo e(route('type.update',['type'=>$type->id])); ?>">
...
unset($__errorArgs, $__bag); ?>" id="name"
                                name="name" value="<?php echo e($type->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="information" name="information"
                                rows="3"><?php echo e($type->information); ?></textarea>
