...
unset($__errorArgs, $__bag); ?>" id="gender" name="gender" aria-label="Default select example">
...
unset($__errorArgs, $__bag); ?>" id="job"
                                    name="job" value="<?php echo e(old('job')); ?>">
                                <?php $__errorArgs = ['job'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-Hotel-main\Laravel-Hotel-main\resources\views/transaction/reservation/createIdentity.blade.php ENDPATH**/ ?>